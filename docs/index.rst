...
*extensible*. By *expressive*, we mean that FEZ aims to operate at a conceptually
higher level than AFDKO, and gives you simpler and more automated ways to express
what you want to achieve. By *extensible*, we expect you to write your own
extensions to the language in Python to generate rules instead of hand-coding them.
